...
var textMappings = {
    ...
    'copypaste-label': 'option_clipboard_permission',
    'copypaste-desc': 'option_clipboard_permission_desc',
...
var setUpOptions = function() {
    ...
    utils.checkNativeClient(function(response) {
        if (response) {
            ...
            document.getElementById('copypaste-option').style.display = 'none'
        }
    })
}
...
var setUpClipboardPermission = function() {
    var clipboardPermissionCheckbox = document.getElementById('copypaste-checkbox')
